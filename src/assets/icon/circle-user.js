import "./circle-user.css";

export default function CircleUser() {
    return (
        <span className={"circle-user"}>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-user"
                 className="svg-inline--fa fa-circle-user " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
